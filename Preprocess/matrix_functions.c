 ...
 ** Jan 25, 2006 - adapt for RMAExpress
 **
 ********************************************************************/
 ...
 ** and which library routines to use. 0 is LINPACK, 1 is LAPACK
 **
...
static int SVD_compute(double *X, int n, double *s, double *u, double *v,int lapack){
  ...
  int job = 21;
  //char jobz = 'A';
  double *Xcopy= (double *)calloc(n*n,sizeof(double));              /* Calloc(n*n,double); */
  double *e =    (double *)calloc(n,sizeof(double));                /* Calloc(n,double); */
  double *work =  (double *)calloc(n,sizeof(double));               /* Calloc(n,double); */
  double *work2 =  (double *)calloc(lwork,sizeof(double));
  int *iwork = (int *)calloc(8*n,sizeof(int));
