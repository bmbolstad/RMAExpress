...
RMAExpress is provided as a dmg file (Apple Disk Image). INsallation of the RMAExpress and RMADataConv applications can be carried out by dragging and dropping the icons onto the Applications alias.

\begin{center}
\includegraphics[scale=0.5]{MacOSX_InstallerWindow.png}
\end{center
