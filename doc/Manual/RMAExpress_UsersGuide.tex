...
It is recommended you use your own wxwidgets installation, rather than one which may be supplied by your version of OS X. You will need to have Xcode and the command line utilities installed to be able to build RMAExpress. The scope of installing these is outside the details of this document. This user guide assumes that you have already have wxWidgets installed. To built native OS X binaries using the source code you should do the following
\begin{verbatim}
      make MacApps
      make console
\end{verbatim}
